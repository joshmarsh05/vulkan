...
struct ColorPickerCommandBufferData {
    VkCommandPool colorPickerCommandPool;
    VkCommandBuffer colorPickerCommandBuffer;
};

struct ColorPickerPipelineInfo {
    VkPipeline colorPickerPipeline;
    VkPipelineLayout colorPickerPipelineLayout;
};
