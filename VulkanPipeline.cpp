...
PipelineInfo VulkanRenderer::CreateGraphicsPipeline(int setLayoutCount, VkDescriptorSetLayout* descriptorSetLayout,
    ...
    vertexInputInfo.vertexBindingDescriptionCount = 1; //maybe change
    ...
    range.stageFlags = VK_SHADER_STAGE_VERTEX_BIT; // both vert and frag
    range.offset = 0;
